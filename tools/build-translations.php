...
$translations = array(
	'ru_RU' => array(
		...
		'Set products missing from the Totobi list out of stock in selected categories' => 'Ставить товары, отсутствующие в списке Totobi, в статус нет в наличии в выбранных категориях',
		'Disabled by default. When enabled, products in the selected WooCommerce categories that are not found in the current Totobi feed are set to out of stock with quantity 0.' => 'По умолчанию выключено. Если включить, товары из выбранных категорий WooCommerce, которых нет в текущем фиде Totobi, будут переведены в статус нет в наличии с количеством 0.',
	...
	'uk' => array(
		...
		'Set products missing from the Totobi list out of stock in selected categories' => 'Ставити товари, відсутні у списку Totobi, у статус немає в наявності у вибраних категоріях',
		'Disabled by default. When enabled, products in the selected WooCommerce categories that are not found in the current Totobi feed are set to out of stock with quantity 0.' => 'За замовчуванням вимкнено. Якщо увімкнути, товари з вибраних категорій WooCommerce, яких немає в поточному фіді Totobi, будуть переведені у статус немає в наявності з кількістю 0.',
